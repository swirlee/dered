...
<body>
	<div class="cont">
		...
		<div class="settab">
			...
			<span class="tabs">
				<a href="/floor/goods_floor_list">管理</a>|<a class="this" href="">新增</a>	 
			</span>
			<span class="tab-two"></span>
		</div>
		
		<form name="theForm" id="theForm" action="/floor/floor_save" method="post">
			...
			<div class="setcont">
				<ul class="set1">
					...
					<li><span class="webname"><input name="floor_name" id="floor_name" type="text" size="40"></span></li>
				</ul>
				<ul class="set1">
					<li>
				...
				<ul class="set1">
					<li>显示</li>
					<img width="61" height="23" id="floor_display_img" style="cursor: pointer;" src="/images/on.jpg">
				</ul>
				<ul class="set1">
					<li>排序</li>
					<li>
						<span class="webname">
							<input name="floor_seq" id="floor_seq" type="text" value="0"> 
				        </span>
				        <span id="nothis">
					        <strong class="q"></strong>
